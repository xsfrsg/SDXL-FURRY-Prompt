...
其实还是想说明一下，鉴别不用光靠看画风的。目前最有效的方法是保存图片（原图最好，截图也行）ps里用吸管在亮度高的纯色色块上滑动，看颜色标尺，ai的话会有高频率的抽动，正常手绘的最多有缓慢微小的色偏（因为图片被压缩过有一定的噪点），总之，刚才截图试了一下，左图自然很多，右图衣领那块颜色标尺都要抖得飞起来了